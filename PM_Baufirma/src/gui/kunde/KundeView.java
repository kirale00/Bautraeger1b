...
public class KundeView{
	...
	private MenuItem innentuerenMenuItem= new MenuItem("Innentueren");
	private MenuItem heizungenMenuItem= new MenuItem("Heizungentueren");
	...
	private void initListener(){
		...
		innentuerenMenuItem.setOnAction(aEvent-> {
			kundeControl.oeffneAussenanlagenControl();
		});
		heizungenMenuItem.setOnAction(aEvent-> {
			kundeControl.oeffneAussenanlagenControl();
		});
	}
