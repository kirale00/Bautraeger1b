...
public class heizungenTest {
    ...
    void setUp() {
        ...
        swArray = swArrayList.subList(18, 23); // Sonderwünsche die zu fensterAussentueren gehören
    }
    ...
    @Test                                               
    @DisplayName("Die Sonderwuensche zu den Heizungen muessen alle einen Preis vermerkt haben!")   
    void habenPreise() {
    ...
    @Test                                               
    @DisplayName("Alle Heizungen müssen einen Namen vermerkt haben")   
    void habenNamen() {
        for(Sonderwunsch s  : swArray) {
